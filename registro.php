<?php include_once 'includes/templates/header.php'; ?>
  ...
  <section class="section contenedor">
     ...
     <form class="registro" class="registro" action="index.html" method="post">
     ...
     <div id="resumen" class="resumen">
        ...
        <div class="caja clearfix">
            <div class="extras">
               <div class="orden">
                   <label for="camisa_evento">Camisa el evento $10 <small>(promoción 7% dto.)</small></label>
